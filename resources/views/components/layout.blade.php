...
<body
    ...
    <header class="w-full max-w-[90%] text-sm mb-6 not-has-[nav]:hidden">
    ...
    <div
        ...
        <main
            class="max-w-[90%] w-full p-6 flex items-center justify-center flex-col border border-2 rounded-md dark:border-stone-400 overflow-auto">
            {{ $slot }}
        </main>
    </div>
</body>
